...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-3 md:py-5 flex items-center justify-between">
        <Link href="/" aria-label="トモラボ ホームへ戻る" className="flex items-center gap-2">
          <Image
        ...
        <nav aria-label="メインナビゲーション" className="flex items-end gap-1 sm:gap-2 md:gap-4">
