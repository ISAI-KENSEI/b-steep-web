  ...
  return (
    <section ref={sectionRef} className="py-24 md:py-32 relative overflow-hidden" style={{ backgroundColor: '#a5c0dd' }}>
      ...
      <Image
        ...
        width={806}
        height={376}
        className="absolute bottom-16 right-0 w-48 h-auto md:w-72 opacity-55 z-0"
      />
      <Image
        ...
        width={100}
        height={100}
        className="absolute bottom-20 left-8 md:bottom-28 md:left-16 w-20 h-auto md:w-28 opacity-50 z-0"
      />
      <Image
      ...
      <div className="text-center mb-20 md:mb-28 px-6 relative z-10">
        ...
        <h2 className="reveal opacity-0 font-mplus text-3xl md:text-5xl lg:text-6xl font-black tracking-wide text-white">
          トモラボってどんなところ?
        </h2>
      </div>

      {/* コンテンツ：左イラスト＋右テキスト */}
      <div className="max-w-6xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start gap-12 md:gap-24">
        {/* 右：テキスト */}
        <div className="reveal opacity-0 w-full pt-0 md:pt-8">
          <h3 className="text-xl md:text-2xl lg:text-3xl font-normal text-white mb-8 md:mb-10 tracking-wide leading-relaxed">
            教科書の学校ではなく、みんなで手を動かす「実験室（ラボ）」
          </h3>
          <p className="text-base md:text-lg leading-[2] md:leading-[2.2] mb-8">
          ...
          <p className="text-base md:text-lg leading-[2] md:leading-[2.2]">
