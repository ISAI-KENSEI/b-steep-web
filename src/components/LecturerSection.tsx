  ...
  return (
    <section ref={sectionRef} className="py-24 md:py-32 relative overflow-hidden" style={{ backgroundColor: '#bfc5d4' }}>
      ...
      <Image
        ...
        width={50}
        height={50}
        className="absolute top-24 right-16 md:top-32 md:right-24 w-12 aspect-square md:w-14 opacity-65 z-0"
      />
      <Image
        ...
        width={45}
        height={45}
        className="absolute bottom-28 left-16 md:bottom-36 md:left-24 w-10 aspect-square md:w-12 opacity-70 z-0"
      />
      <Image
        ...
        width={95}
        height={95}
        className="absolute top-[55%] right-[8%] w-20 h-auto md:w-26 opacity-40 z-0"
      />
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="reveal opacity-0 flex flex-col md:flex-row gap-12 md:gap-20 items-start">
          {/* 左：プロフィール写真 */}
          ...
          <div className="w-full md:w-3/5">
            <div className="mb-6">
              ...
              <h3 className="font-mplus text-3xl md:text-4xl font-black mb-2">
                武藤 匠吾（トモ）
              </h3>
            ...
            <p className="text-base md:text-lg leading-8 md:leading-9 mb-6">
            ...
            <p className="text-base md:text-lg leading-8 md:leading-9 mb-8">
